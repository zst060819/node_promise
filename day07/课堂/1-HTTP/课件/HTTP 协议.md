...
1. 配置 Tools -> options -> HTTPS -> 勾选左侧的两个选项 -> 在弹出的对话框中选择 yes 安装证书

2. 关闭其他的代理工具. 比如 谷歌助手 、小飞机等等
...
- 500：(Server Internal Error)请求资源找到了，但服务器内部出现了错误；
